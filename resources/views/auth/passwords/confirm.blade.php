        ...
        >
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="container mx-auto">
              ...
              <h2 class="text-4xl fw-bold color-palette-1 mb-10">Hai, Sobat laut</h2>
              ...
              <div class="pt-30">
                ...
                <div class="pt-30">
                    <label for="password-confirm" class="form-label text-lg fw-medium color-palette-1 mb-10">{{ __('Confirm Password') }}</label>

                    <input id="password-confirm" type="password" class="form-control rounded-pill text-lg" name="password_confirmation" required autocomplete="new-password">
