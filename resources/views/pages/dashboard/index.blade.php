...
<section class="overview overflow-auto">
        <main class="main-wrapper">
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Dashboard Overview</h2>
                            ...
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Registered<br>Account</p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total</p>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">180</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Student<br></p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total</p>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">200</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                                <div class="categories-card">
                                    <div class="d-flex align-items-center mb-24">
                                        ...
                                        <p class="color-palette-1 mb-0 ms-12">Alumnus</p>
                                    </div>
                                    <div>
                                        <p class="text-sm color-palette-2 mb-1">Total</p>
                                        <p class="text-2xl color-palette-1 fw-medium m-0">80</p>
                                    </div>
                                </div>
                            </div>
                        </div>
