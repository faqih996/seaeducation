        ...
        <main class="main-wrapper">
            <div class="ps-lg-0">
                @if(session()->has('success'))
                        ...
                        @endif
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Master gallery</h2>
                <div class="top-up-categories mb-30">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="{{ url('gallery/create') }}" class="btn btn-primary shadow-sm">
                                    ...
                                    <tbody class="text-center">
                                        @forelse($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ Storage::url($item->image) }}" alt="" class="img-tumbnail" />
                                                </td>
                                                <td>
                                                    <a href="{{ url('/gallery/update', $item->id) }}" class="btn btn-info">
