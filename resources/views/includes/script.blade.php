    ...
    <script src="{{url('https://cdnjs.cloudflare.com/ajax/libs/Swiper/6.4.8/swiper-bundle.min.js')}}"></script>
    <script src="{{url('frontend/libraries/bootstrap/js/scripts.js')}}"></script>
-->
